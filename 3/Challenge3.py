...
str = open("1.txt").read()
str = r"""kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
matchPattern = r"[^A-Z][A-Z]{3}([a-z])[A-Z]{3}[^A-Z]"

list1 = re.findall(matchPattern,str,re.MULTILINE)
if(list1):
    finalStr = "".join(list1)
else:
    finalStr = ""
